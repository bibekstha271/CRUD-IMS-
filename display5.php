...
<div class="container">
    <h2 class="text-center">Suppliers Information</h2> 
...
<script>
    ...
    <div class="d-flex justify-content-between button-container">
        <button class="btn btn-add text-white">
            <a href="create5.php" class="text-light" style="text-decoration: none;">
                <i class="fas fa-plus"></i> Add new suppliers
            </a>
        </button>
        <button class="btn btn-search text-white">
            <a href="search5.php" class="text-light" style="text-decoration: none;">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                            ...
                            <td>' . $address . '</td>
                            <td>
                                <a href="edit5.php?id=' . $id . '" class="btn btn-warning btn-sm">Edit</a>
                                <a href="delete5.php?id=' . $id . '" class="btn btn-danger btn-sm" onclick="return confirmDelete();">Delete</a>
                            </td>
                        </tr>';
                    }
                } else {
