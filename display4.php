...
<script>
    ...
    <div class="d-flex justify-content-between button-container">
        <button class="btn btn-add text-white">
            <a href="create4.php" class="text-light" style="text-decoration: none;">
                <i class="fas fa-plus"></i> Add Items
            </a>
        </button>
        <button class="btn btn-search text-white">
            <a href="search4.php" class="text-light" style="text-decoration: none;">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                            ...
                            <td>
                                <a href="edit4.php?id=' . $id . '" class="btn btn-warning btn-sm">Edit</a>
                                <a href="delete4.php?id=' . $id . '" class="btn btn-danger btn-sm" onclick="return confirmDelete();">Delete</a>
                            </td>
                        </tr>';
                    }
                } else {
