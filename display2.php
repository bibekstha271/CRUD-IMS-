...
<div class="container">
    <h2 class="text-center">Inventory 2</h2> 
...
<script>
    ...
    <div class="d-flex justify-content-between button-container">
        <button class="btn btn-add text-white">
            <a href="create2.php" class="text-light" style="text-decoration: none;">
                <i class="fas fa-plus"></i> Add Items
            </a>
        </button>
        <button class="btn btn-search text-white">
            <a href="search2.php" class="text-light" style="text-decoration: none;">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                            ...
                            <td>
                                <a href="edit2.php?id=' . $id . '" class="btn btn-warning btn-sm">Edit</a>
                                <a href="delete2.php?id=' . $id . '" class="btn btn-danger btn-sm" onclick="return confirmDelete();">Delete</a>
                            </td>
                        </tr>';
                    }
                } else {
