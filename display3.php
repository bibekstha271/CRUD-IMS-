...
<div class="container">
    <h2 class="text-center">Inventory 3</h2> 
...
<script>
    ...
    <div class="d-flex justify-content-between button-container">
        <button class="btn btn-add text-white">
            <a href="create3.php" class="text-light" style="text-decoration: none;">
                <i class="fas fa-plus"></i> Add Items
            </a>
        </button>
        <button class="btn btn-search text-white">
            <a href="search3.php" class="text-light" style="text-decoration: none;">
