...
<div class="container">
    <h2 class="text-center">Clients Information</h2> 
...
<script>
    ...
    <div class="d-flex justify-content-between button-container">
        <button class="btn btn-add text-white">
            <a href="create(clients).php" class="text-light" style="text-decoration: none;">
                <i class="fas fa-plus"></i>  New Clients
            </a>
        </button>
        <button class="btn btn-search text-white">
            <a href="search(clients).php" class="text-light" style="text-decoration: none;">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Company Name</th>
                    <th>Email</th>
                    <th style="float:left;">Contact</th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                            ...
                            <td>' . $name2 . '</td>
                            <td>' . $email . '</td>
                            <td>' . str_replace(',', '<br>', htmlspecialchars($contact)) . '</td>
                            <td>
                                <a href="edit(clients).php?id=' . $id . '" class="btn btn-warning btn-sm">Edit</a>
                               <a href="delete(clients).php?id=' . $id . '" class="btn btn-danger btn-sm" onclick="return confirmDelete();">Delete</a>
                            </td>
                        </tr>';
                    }
                } else {
